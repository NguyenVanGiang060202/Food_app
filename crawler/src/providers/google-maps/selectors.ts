export const SELECTORS = {
  ...
  reviewCountItem: '.UY7F9, span[aria-label*="review" i], span[aria-label*="đánh giá" i], button[aria-label*="review" i], button[aria-label*="đánh giá" i]',
  reviewCountFallback: '[aria-label*="review" i], [aria-label*="đánh giá" i], [data-review-count]',
  reviewCountButton: 'button[aria-label*="review" i], button[aria-label*="đánh giá" i], span[aria-label*="review" i], span[aria-label*="đánh giá" i]',
  reviewCountInDetail: 'button[aria-label*="review" i], button[aria-label*="đánh giá" i], [role*="review" i], [data-review-count]',
  ...
  detailPhone: 'button[data-item-id*="phone"], a[href^="tel:"], [aria-label*="phone" i], [aria-label*="điện thoại" i]',
