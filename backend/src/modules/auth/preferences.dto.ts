...
export class AiPreferencesDto {
  ...
  @IsOptional() @IsIn(['under-100', '100-200', '200-500', 'any']) budget?:
    'under-100' | '100-200' | '200-500' | 'any';
  ...
  @IsOptional() @IsIn(['popular', 'hidden-gems', 'new', 'local']) recommendationStyle?:
    'popular' | 'hidden-gems' | 'new' | 'local';
  @IsOptional()
  @IsIn(['distance', 'quality', 'rating', 'price', 'atmosphere'])
  ...
  @Type(() => PreferenceMemoryDto)
  memories?: PreferenceMemoryDto[];
}
