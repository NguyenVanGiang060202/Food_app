...
import { assertProductionOrigins, assertProductionSecrets, parseAllowedOrigins, parsePositiveInteger, rateLimit, requestSizeLimit, resolveFrontendOrigin, securityHeaders } from './common/http-security';
...
async function bootstrap(): Promise<void> {
    ...
    assertProductionSecrets({ authSecret: process.env.AUTH_SECRET, adminApiKey: process.env.ADMIN_API_KEY });
